        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-12">
          <div className="lg:col-span-2">
            ...
            <div className="flex items-center gap-3">
              <a 
                href="mailto:acadeemy84@gmail.com" 
                className="w-11 h-11 bg-white/10 rounded-xl flex items-center justify-center hover:scale-110 hover:bg-white/20 active:scale-95 transition-all duration-200"
                aria-label="ایمیل"
              >
          ...
          <div>
            ...
            <ul className="space-y-3 text-white/70 text-sm">
              <li className="flex items-start gap-3">
                ...
                <a href="mailto:acadeemy84@gmail.com" className="hover:text-white transition-colors break-all">
              ...
              <li className="flex items-start gap-3">
                ...
                <a href="tel:09133139424" className="hover:text-white transition-colors">
                  09133139424
                </a>
              </li>
              <li className="flex items-start gap-3">
                ...
                <span>شعبه ۱: کاشان، خیابان بهشتی — شعبه ۲: قم، سالاریه</span>
              </li>
            </ul>
          </div>
        </div>
