  ...
  return (
    <div className="opacity-0 animate-fade-in-card h-full" style={{ animationDelay: `${index * 100}ms` }}>
      <Link 
        ...
        className="group block bg-white rounded-2xl shadow-soft overflow-hidden border border-primary-100 h-full flex flex-col transition-all duration-300 hover:shadow-soft-xl hover:border-accent-200 hover:-translate-y-1"
      >
        ...
        <div className="p-4 sm:p-6 flex-grow flex flex-col">
          ...
          <div className="flex items-center justify-between text-sm">
            ...
            <span className="flex items-center gap-2 text-accent-600 font-bold group-hover:gap-3 transition-all duration-200">
              مشاهده دوره
