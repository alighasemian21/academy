...
const faqSchemaItems = [
  ...
  { question: 'چگونه می‌توانم در دوره ثبت‌نام کنم؟', answer: 'می‌توانید از طریق صفحه ثبت‌نام آنلاین، فرم مربوطه را پر کرده و منتظر تماس ما بمانید. همچنین می‌توانید با شماره تماس 0913-313-9424 تماس بگیرید.' },
  ...
  { question: 'محل برگزاری دوره‌ها کجاست؟', answer: 'دوره‌ها در آکادمی 84 واقع در کاشان- خیابان شهید بهشتی برگزار می‌شوند.' },
