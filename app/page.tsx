          ...
          <AnimatedSection animation="fade-in-up">
            ...
            <div className="grid md:grid-cols-2 gap-6 lg:gap-8">
              <AnimatedSection animation="fade-in-up" delay={100}>
                <motion.div 
                  className="p-8 rounded-3xl bg-gradient-to-br from-primary-50 to-white border border-primary-100 group"
                  whileHover={{ 
                    y: -8, 
            ...
            <AnimatedSection animation="fade-in-up">
              ...
              >
                <Link
                  ...
                  className="inline-flex items-center gap-3 px-10 py-4 bg-primary-900 text-white rounded-2xl font-bold text-lg hover:bg-primary-800 transition-all duration-300 shadow-soft-lg hover:shadow-soft-xl"
                >
                  مشاهده تمام دوره‌ها
                  <motion.svg 
                    className="w-5 h-5" 
            ...
            <AnimatedSection animation="fade-in-up">
              ...
              >
                <Link
                  ...
                  className="inline-flex items-center gap-3 px-10 py-4 bg-white text-primary-900 border-2 border-primary-900 rounded-2xl font-bold text-lg hover:bg-primary-50 hover:border-primary-800 transition-all duration-300 shadow-soft hover:shadow-soft-lg"
                >
                  مشاهده تمام خدمات
                  <motion.svg 
                    className="w-5 h-5" 
