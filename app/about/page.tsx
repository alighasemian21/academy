export const metadata = {
  ...
  description: 'درباره علی قاسمیان، آکادمی و شرکت',
};
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-gray-700 leading-relaxed mb-4">
                من علی قاسمیان، مدیر و بنیان‌گذار آکادمی و شرکت هستم. با بیش از ۱۰ سال تجربه در زمینه مدیریت، آموزش و ارائه خدمات تخصصی، هدف من کمک به رشد و پیشرفت افراد و کسب‌وکارها است.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4">
