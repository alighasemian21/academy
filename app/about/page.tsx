      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
            <h2 className="text-3xl font-bold mb-6">آکادمی 84</h2>
            <div className="prose prose-lg max-w-none">
              <p className="text-gray-700 leading-relaxed mb-4">
                آکادمی 84 یک مجموعه آموزشی و تخصصی است که با بیش از ۱۰ سال تجربه در زمینه مدیریت، آموزش و ارائه خدمات تخصصی، هدف ما کمک به رشد و پیشرفت افراد و کسب‌وکارها است.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                شرکت ما نیز با تیمی متخصص و با تجربه، خدمات متنوعی از جمله طراحی و توسعه وبسایت، مشاوره کسب‌وکار، برندینگ و بازاریابی دیجیتال را ارائه می‌دهد.
              </p>
            </div>
          </div>
